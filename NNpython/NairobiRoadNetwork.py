...
#from Greedybfs import Greedy_BfsTraverser
from classes.a_star import StarTraverser
...
#routes = route_bfs.greedy_BFS(G, "Karen", "Imara Daima")

route_bfs = StarTraverser()
routes = route_bfs.a_star(G, "karen", "imara daima")
